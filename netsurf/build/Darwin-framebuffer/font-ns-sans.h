...
extern const uint8_t *fb_regular_section_table;
extern const uint16_t *fb_regular_sections;
extern const uint8_t *fb_italic_section_table;
extern const uint16_t *fb_italic_sections;
extern const uint8_t *fb_bold_section_table;
extern const uint16_t *fb_bold_sections;
extern const uint8_t *fb_bold_italic_section_table;
extern const uint16_t *fb_bold_italic_sections;
extern const uint8_t *font_glyph_data;
